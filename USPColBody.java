 ...
 * @version 1.0
 */
public class USPColBody implements Body{
    ...
    double xVelDelta;
    double yVelDelta;
    ArrayList<Body> collided = new ArrayList<Body>();

    /**
     * Constructor for ColBody
     */
    public USPColBody(double xc, double yc, double xv, double yv, double m,double rad,  int rI, int gI, int bI){
	xCoord = xc;
        yCoord = yc;
        xVelocity = xv;
        yVelocity = yv;
